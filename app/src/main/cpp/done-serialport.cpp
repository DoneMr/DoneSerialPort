...
Java_com_done_doneserialport_SerialPort_open(JNIEnv *env, jclass thiz, jstring path, jint baudrate,
                                             jint stopBits,
...
Java_com_done_doneserialport_SerialPort_close(JNIEnv *env, jobject instance) {
...
Java_com_done_doneserialport_SerialPort_stringFromJNI(JNIEnv *env, jobject instance) {
